...
struct AllAssets {
    ...
    let assets: [String] = [
        ...
        "belalang", "berat", "bermain", "besar", "bidan", "bintang", "bis",
        ...
        "petani", "peternak", "piring", "pizza", "pena", "pengering rambut",
        "plester", "pohon", "polisi", "potong", "print", "puding", "putar",
        "rak buku", "rautan", "resleting", "robot", "rok", "roti",
        "roti panggang", "roti lapis", "rumah", "sabun", "sarung tangan",
        ...
        "tukang pos", "tutup", "uang", "ular", "virus", "wajan", "warnai", "ya",
        "youtube", "kunyah",
        "menggambar",
        "mengantuk",
        "mendengar",
