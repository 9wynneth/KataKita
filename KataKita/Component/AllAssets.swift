...
struct AllAssets {
    ...
    let assets: [String] = [
        ...
        "youtube", "kunyah", "menggambar", "mengantuk", "mendengar",
        "ganti baju", "gatal", "gelap", "terang", "nyaman", "guling", "selimut",
        "sprei", "masak", "goreng", "aduk", "pisau", "talenan", "menonton",
    ...
    let englishAssets: [String] = [
        ...
        "apple", "fire", "salty", "astronaut", "watch out", "father", "chicken",
        "fried chicken", "pig", "how", "clothes", "bathtub", "block", "balloon",
        "hot air balloon", "bolt", "baby", "swim", "pillow", "stone",
        "grasshopper", "heavy", "play", "big", "midwife", "star", "bus", "ball",
        "bottle", "bowling", "fruit", "open", "book", "moon", "earth", "flower",
        "burger", "bird", "foam", "dragonfly", "pants", "shorts",
        "small mirror", "mirror", "chocolate", "crayon", "house love",
        "wash hands", "wash dishes", "and", "delete", "deodorant", "detergent",
        ...
        "mountain", "teacher", "hair dryer", "towel", "hanger", "helicopter",
        "helmet", "phone", "headset", "shark", "rain", "forest", "mother",
        ...
        "contractor", "stove", "suitcase", "match", "first aid kit",
        "pencil case", "toy box", "id card", "brush", "cat", "horse", "cake",
        "cookie", "key", "refrigerator", "butterfly", "turtle", "chair",
        "wheelchair", "lamp", "traffic light", "night lamp", "kite", "bee",
        "glue", "wardrobe", "elevator", "candle", "lipstick", "lotion", "toy",
        "shower", "sweet", "folder", "enter", "sun", "table", "study table",
        "cut", "paste", "washing machine", "cutting", "write", "brush teeth",
        ...
        "farmer", "rancher", "plate", "pizza", "pen", "hair dryer", "band-aid",
        "tree", "police", "cut", "print", "pudding", "spin", "bookshelf",
        "sharpener", "zipper", "robot", "skirt", "bread", "toast", "sandwich",
        "house", "soap", "gloves", "sandals", "finish", "watermelon", "ant",
        "spoon", "shoes", "bicycle", "iron", "shampoo", "shower", "toothbrush",
        "razor", "lion", "comb", "soda", "sofa", "sausage", "water plants",
        "sponge", "highlighter", "done", "soup", "letter", "sushi", "nurse",
        "milk", "sweater", "bag", "tea", "television", "egg", "phone",
        "thermometer", "scale", "tissue", "tissue roll", "toilet", "help",
        "trash can", "trolley", "hat", "truck", "postman", "close", "money",
        "snake", "virus", "frying pan", "color", "yes", "youtube",
        "chew", "draw", "sleepy", "hear", "change clothes", "itchy", "dark",
        "bright", "comfortable", "bolster", "blanket", "bed sheet", "cook",
        "fry", "stir", "knife", "cutting board", "watch", "listen", "storybook",
    ]
