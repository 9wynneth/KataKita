...
class AACRuangMakanViewModel: ObservableObject {
    ...
    private var rawData: [[(String, String, String, String)]] = [
        ...
        [("sendok", "sendok", "#F2B95C", "#000000"), ("garpu", "garpu", "#F2B95C", "#000000"), ("piring", "piring", "#F2B95C", "#000000"), ("sup", "mangkok", "#F2B95C", "#000000"), ("gelas air", "gelas", "#F2B95C", "#000000")],
        [("ayam goreng", "ayam goreng", "#F2B95C", "#000000"), ("nasi", "nasi", "#F2B95C", "#000000"), ("mie", "mie", "#F2B95C", "#000000"), ("susu", "susu", "#F2B95C", "#000000"), ("teh", "teh", "#F2B95C", "#000000")],
